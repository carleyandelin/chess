...
public class EscapeSequences {
    ...
    // Custom pastel board colors
    public static final String SET_BG_COLOR_LIGHT_PINK = UNICODE_ESCAPE + "[48;5;218m";
    public static final String SET_BG_COLOR_DARK_PURPLE = UNICODE_ESCAPE + "[48;5;54m";
